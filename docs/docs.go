        ...
        "schemas": {
            ...
            "dto.ChangeLogVO": {
                "properties": {
                    ...
                    "userName": {
                        "description": "操作者昵称；未设置时回退为 OpenID，用户不存在时为空",
                        "type": "string"
                    }
                },
                "type": "object"
            ...
            "dto.FieldSuggestionVO": {
                "properties": {
                    ...
                    "title": {
                        "description": "teacherName 建议固定返回教师职称（历史教师无职称时为空字符串）；其他字段省略",
                        "type": "string"
                    },
                    "value": {
            ...
            "dto.RevokeProposalReq": {
                "properties": {
                    "actionType": {
                        "description": "必填；approve 仅可在最近审批通过后不足 24 小时内撤回，reject 撤回已拒绝提案且无时间限制",
                        "type": "string"
                    }
                },
                "type": "object"
            ...
            "dto.SearchSuggestionsVO": {
                "properties": {
                    "name": {
                        "description": "建议实体名称；教师建议仅为姓名，不包含职称",
                        "type": "string"
                    },
                    "searchValue": {
                    ...
                    "title": {
                        "description": "教师建议固定返回职称（历史教师无职称时为空字符串）；其他类型省略",
                        "type": "string"
                    },
                    "type": {
            ...
            "handler.Response-dto_DeleteCommentResp": {
                "properties": {
                    "code": {
                        "description": "业务代码, 0表示成功",
                        "example": 0,
            ...
            "handler.Response-dto_ResubmitProposalResp": {
                "properties": {
                    "code": {
                        "description": "业务代码, 0表示成功",
                        "example": 0,
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/handler.Response-dto_DeleteCommentResp"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/handler.Response-dto_ResubmitProposalResp"
                                }
                            }
                        },
                        "description": "OK"
