...
type IMongoRepo interface {
	...
	FindMany(ctx context.Context, keyword string, param *dto.PageParam) ([]*Course, int64, error)
	...
	GetCourseSuggestions(ctx context.Context, keyword string, param *dto.PageParam) ([]*Course, error)
	CountCourses(ctx context.Context, keyword string) (int64, error)
	FindCoursesByTeacherID(ctx context.Context, teacherID string, param *dto.PageParam) ([]*Course, int64, error)
	FindCoursesByCategoryID(ctx context.Context, categoryID int32, param *dto.PageParam) ([]*Course, int64, error)
	FindCoursesByDepartmentID(ctx context.Context, departmentID int32, param *dto.PageParam) ([]*Course, int64, error)
}
...
func (m *MongoRepo) FindOneByID(ctx context.Context, ID string) (*Course, error) {
...
func (m *MongoRepo) FindMany(ctx context.Context, keyword string, param *dto.PageParam) ([]*Course, int64, error) {
...
func (m *MongoRepo) GetDepartments(ctx context.Context, keyword string) ([]int32, error) {
...
func (m *MongoRepo) GetCategories(ctx context.Context, keyword string) ([]int32, error) {
	if keyword == "" {
		return nil, nil
	}
	filter := bson.M{"$or": []bson.M{{consts.Name: keyword}, {consts.Code: keyword}}}
...
func (m *MongoRepo) GetCampuses(ctx context.Context, keyword string) ([]int32, error) {
	if keyword == "" {
		return nil, nil
	}
	filter := bson.M{"$or": []bson.M{{consts.Name: keyword}, {consts.Code: keyword}}}
...
func (m *MongoRepo) GetCourseSuggestions(ctx context.Context, keyword string, param *dto.PageParam) ([]*Course, error) {
	if keyword == "" {
		return nil, nil
	}
	var courses []*Course
...
func (m *MongoRepo) CountCourses(ctx context.Context, keyword string) (int64, error) {
	filter := bson.M{consts.Name: bson.M{"$regex": primitive.Regex{Pattern: keyword, Options: "i"}}}
...
func (m *MongoRepo) FindCoursesByTeacherID(ctx context.Context, teacherID string, param *dto.PageParam) ([]*Course, int64, error) {
	if teacherID == "" {
...
func (m *MongoRepo) FindCoursesByCategoryID(ctx context.Context, categoryID int32, param *dto.PageParam) ([]*Course, int64, error) {
	var courses []*Course
...
func (m *MongoRepo) FindCoursesByDepartmentID(ctx context.Context, departmentID int32, param *dto.PageParam) ([]*Course, int64, error) {
	var courses []*Course
